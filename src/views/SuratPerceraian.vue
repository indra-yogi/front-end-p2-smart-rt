<template>
    <div>
        <div class="Head">
            <table class="form">
                <tr>
                    ...
                    <td style="width: 5%">:</td>
                    <td style="width: 50%">Kalimantan Timur</td>
                </tr>
                <tr>
        ...
        <div class="Body">
            ...
            <p style="text-align: left;">Demikian surat keterangan ini dibuat, untuk dapat dipergunakan sebagaimana mestinya.</p>
